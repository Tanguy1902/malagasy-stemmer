...
pub static SUFFIX_RULES: &[SuffixRule] = &[
    ...
    SuffixRule { suffix: "ina", restorations: &["y", "a", "na", "tra", "ka", "ra", "e"], weight: 0.9 },
    SuffixRule { suffix: "ana", restorations: &["a", "y", "na", "tra", "ka", "ra", "e", "o"], weight: 0.9 },
    SuffixRule { suffix: "ena", restorations: &["y", "a", "na", "tra", "ka", "ra", "e"], weight: 0.9 },
    SuffixRule { suffix: "ona", restorations: &["y", "a", "o", "na", "tra", "ka"], weight: 0.9 },
    ...
    SuffixRule { suffix: "io", restorations: &["y", "a", "tra", "ka"], weight: 0.85 },
    SuffixRule { suffix: "ao", restorations: &["a", "y", "tra", "ka"], weight: 0.85 },
    SuffixRule { suffix: "eo", restorations: &["y", "a", "tra"], weight: 0.85 },
    SuffixRule { suffix: "o", restorations: &["y", "a", "na", "tra", "ka"], weight: 0.85 },
    SuffixRule { suffix: "y", restorations: &["tra", "ka", "na", "a"], weight: 0.85 },
];
